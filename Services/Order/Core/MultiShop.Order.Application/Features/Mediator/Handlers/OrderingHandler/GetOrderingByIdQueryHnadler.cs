...
{
    public class GetOrderingByIdQueryHnadler : IRequestHandler<GetOrderingByIdQuery, GetOrderingByIdQueryResult>
    {
        private readonly IRepository<Ordering> _repository;

        public GetOrderingByIdQueryHnadler(IRepository<Ordering> repository)
        {
